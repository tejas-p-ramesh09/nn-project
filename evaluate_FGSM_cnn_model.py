...
print("\n" + "=" * 60)
print("FGSM ADVERSARIAL TEST PERFORMANCE - CNN")
print("=" * 60)
...
plt.title(f"Confusion Matrix - FGSM CNN on MNIST (epsilon={EPSILON})")
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/CM_fgsm_cnn_mnist_eps{EPSILON}.png", dpi=300, bbox_inches="tight")
plt.show()
...
plot_reliability_diagram(
    ...
    all_labels,
    n_bins=10,
    save_path=f"{VIS_DIR}/Reliability_Diagram_fgsm_cnn_mnist_eps{EPSILON}.png",
    title=f"Reliability Diagram (FGSM CNN, epsilon={EPSILON})",
)
...
plt.title(f"Confidence Distribution on FGSM Test Set - CNN (epsilon={EPSILON})")
plt.legend()
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/Conf_Dist_fgsm_cnn_mnist_eps{EPSILON}.png", dpi=300, bbox_inches="tight")
plt.show()