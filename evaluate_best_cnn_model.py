...
def plot_reliability_diagram(confidences, predictions, labels, n_bins=10, save_path=None):
    ...
    plt.ylabel("Accuracy")
    plt.title("Reliability Diagram - CNN")
    plt.legend()
...
print("\n" + "=" * 60)
print("CLEAN TEST PERFORMANCE - CNN")
print("=" * 60)
...
plt.title("Confusion Matrix - Best CNN on MNIST")
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/CM_best_cnn_mnist.png", dpi=300, bbox_inches="tight")
plt.show()
...
plot_reliability_diagram(
    ...
    all_labels,
    n_bins=10,
    save_path=f"{VIS_DIR}/Reliability_Diagram_best_cnn_mnist.png"
)
...
plt.title("Confidence Distribution on Clean Test Set - CNN")
plt.legend()
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/Conf_Dist_best_cnn_mnist.png", dpi=300, bbox_inches="tight")
plt.show()