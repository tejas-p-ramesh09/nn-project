...
print("\n" + "=" * 60)
print("GAUSSIAN NOISE TEST PERFORMANCE")
print("=" * 60)
...
plt.title(f"Confusion Matrix - Noisy MLP on MNIST (sigma={NOISE_SIGMA})")
plt.tight_layout()
...
plot_reliability_diagram(
    ...
    all_labels,
    n_bins=10,
    save_path=f"{VIS_DIR}/Reliability_Diagram_noisy_mlp_mnist_sigma{NOISE_SIGMA}.png",
...
plt.title(f"Confidence Distribution on Noisy Test Set (sigma={NOISE_SIGMA})")
plt.legend()
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/Conf_Dist_noisy_mlp_mnist_sigma{NOISE_SIGMA}.png", dpi=300, bbox_inches="tight")
plt.show()