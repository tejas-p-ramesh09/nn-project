...
print("\n" + "=" * 60)
print("TEMPERATURE SCALING RESULTS (CLEAN TEST) - CNN")
print("=" * 60)
...
plot_reliability_diagram(
    ...
    labels_before,
    n_bins=10,
    save_path=f"{VIS_DIR}/Reliability_Before_TempScaling_CNN.png",
    title="Reliability Diagram Before Temperature Scaling - CNN",
)
...
plot_reliability_diagram(
    ...
    labels_after,
    n_bins=10,
    save_path=f"{VIS_DIR}/Reliability_After_TempScaling_CNN.png",
    title="Reliability Diagram After Temperature Scaling - CNN",
)
...
plt.title("Confidence Distribution Before vs After Temperature Scaling - CNN")
plt.legend()
plt.tight_layout()
plt.savefig(f"{VIS_DIR}/Confidence_Before_After_TempScaling_CNN.png", dpi=300, bbox_inches="tight")
plt.show()